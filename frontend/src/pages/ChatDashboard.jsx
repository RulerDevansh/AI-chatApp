...
const ChatDashboard = () => {
  ...
  useEffect(() => {
    ...
    sidebarElement.addEventListener('touchstart', handleTouchStart, { passive: false });
    sidebarElement.addEventListener('touchmove', handleTouchMove, { passive: false });
    sidebarElement.addEventListener('touchend', handleTouchEnd, { passive: false });
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200 relative">
      ...
      >
        ...
        <div className="lg:hidden absolute right-0 top-0 w-4 h-full bg-transparent cursor-grab active:cursor-grabbing z-10" />
